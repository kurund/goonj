	  ...
	  if (container && resetButton) {
		resetButton.addEventListener("click", function (event) {
		  ...
		  if (scope) {
			...
			scope.$apply();
			/* 
			Note: This reload mechanism is implemented as a temporary measure to prevent form submission with old data after a reset. 
			It will be replaced with a more appropriate solution in the future.
			*/
			setTimeout(function () {
